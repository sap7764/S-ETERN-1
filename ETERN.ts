...
export interface LessonStep {
  ...
  model_interaction_points?: { narration: string; narration_hindi: string; narration_polish: string }[]; // Step-by-step 3D teaching points
}
